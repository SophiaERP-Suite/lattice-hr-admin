...
const companyData = [
    ...
    {
        User: "Maplewood Engineering Ltd.",
    ...
    return <div className="container-fluid">
        <div className="row">
            <div className="col-xl-12">
                <div className="page-title-box d-flex-between flex-wrap gap-15">
                    <h1 className="page-title fs-18 lh-1">User Management</h1>
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb breadcrumb-example1 mb-0">
                            <li className="active breadcrumb-item" aria-current="page">
                                <NavLink to="/ControlPanel/UserMgt">
                                    User Management
                                </NavLink>
                            </li>
                            <li className="mb-2">
            ...
            <div className="col-12 col-lg-4 col-md-6">
                ...
                <div className="card-body d-flex align-center gap-16">
                    ...
                    <div className="card-content">
                        <span className="d-block fs-16 mb-5">Total Users</span>
            ...
            <div className="col-xl-12">
                <div className="card">
                    <div className="card-header justify-between">
                        <h4 className="d-flex-items gap-10">Users<span className="badge bg-label-primary">82</span></h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div className="d-flex-items gap-10">
                                                            ...
                                                            <h6 className="cursor-pointer" data-bs-toggle="modal" data-bs-target="#viewCompanies">{ data.User }</h6>
                                                        </div>
                                                    </td>
            ...
            <div className="modal-dialog modal-dialog-centered modal-lg">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-16" id="addNewCompaniesLabel">Add New User</h1>
                        ...
                        <div className="row gy-15">
                            <div className="col-xl-12">
                                <div className="text-center">
                                    ...
                                    <span className="d-block fw-5 text-black">User Image</span>
                                </div>
                            </div>

                            <div className="col-xl-12 text-start">
                                <label htmlFor="fullName" className="form-label">User Name</label>
                                <input type="text" className="form-control" id="fullName" placeholder="User Full Name"/>
                            </div>
        ...
        <div className="modal fade" id="viewCompanies" aria-labelledby="viewCompaniesLabel" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-16" id="viewCompaniesLabel">View User Info</h1>
                        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div className="modal-body">
                        <div className="row gy-15">
        ...
        <div className="modal fade" id="editCompanies" aria-labelledby="editCompaniesLabel" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered modal-lg">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-16" id="editCompaniesLabel">Edit User</h1>
                        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div className="modal-body">
                        <div className="row gy-15">
                            <div className="col-xl-12">
                                ...
                                <input type="file" name="photo"
                                    ...
                                    <span className="d-block fw-5 text-muted">User Logo</span>
                                </div>
                            </div>
                            <div className="col-xl-12 text-start">
                                <label htmlFor="fullName2" className="form-label">User Name</label>
